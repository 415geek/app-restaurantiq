...
const COPY: Record<Locale, Copy> = {
  en: {
    ...
    gaps: 'Gaps & openings',
    generatedBy: (p, m) => `Generated by ${p} (${m}) from Google Place Details + Yelp Fusion review excerpts`,
  ...
  zh: {
    ...
    gaps: '可切入的市场缺口',
    generatedBy: (p, m) => `由 ${p} (${m}) 基于 Google Place Details + Yelp Fusion 评论摘要生成`,
  ...
  es: {
    ...
    generatedBy: (p, m) => `Generado por ${p} (${m}) a partir de Google Place Details + extractos de reseñas de Yelp Fusion`,
      ...
      {competitorInsights && competitorInsights.per_competitor?.length > 0 && (
        <SectionShell title={competitorInsightsTitle} icon="🔍">
          ...
          <div className="mt-3 text-[10px] text-zinc-500">
            {c.generatedBy(competitorInsights.provider, competitorInsights.model)}
          </div>
        </SectionShell>
      )}
