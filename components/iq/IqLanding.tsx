  ...
  es: {
    ...
    hero: {
      ...
      headlines: [
        ...
        'Hogares chinos cercanos, competidores del mismo tipo de cocina, punto de equilibrio: 60 segundos',
    ...
    how: {
      ...
      steps: [
        ...
        { n: '2', title: 'Lee el resumen gratuito', body: 'Puntuación general, veredicto (ADELANTE / condicional / NO RECOMENDADO) y las tres observaciones que importan, en aproximadamente un minuto.' },
