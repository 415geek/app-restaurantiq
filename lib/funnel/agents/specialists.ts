...
const competitionAnalyst: SpecialistDef = {
  ...
  user: (i) =>
    [
      ...
      '',
      i.language === 'zh' ? '【该地址过往商家评论主题（实测）】' : '[PRIOR-BUSINESS REVIEW THEMES AT THIS ADDRESS (retrieved)]',
...
const siteAnalyst: SpecialistDef = {
  ...
  user: (i) =>
    [
      ...
      '',
      i.language === 'zh' ? '【该地址过往/现有商家与评论（实测）】' : '[BUSINESSES AT THIS EXACT ADDRESS + REVIEWS (retrieved)]',
