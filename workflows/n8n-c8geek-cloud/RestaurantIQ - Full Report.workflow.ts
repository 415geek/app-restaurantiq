...
export class RestaurantiqFullReportWorkflow {
    ...
    @node({
        id: '82cdbe1c-437a-4ada-836c-c750e9892542',
        webhookId: 'ab49c487-45b7-4c04-a19c-76a38fde8a36',
        name: 'Webhook',
    ...
    @node({
        id: '7d8d62d8-a1c2-47bc-8cc8-da9e825d72d5',
...
return { json: { system: systemWithCuisine, user } };`,
    ...
    @node({
        id: '87a57960-bf65-4374-9694-66af453a038b',
        name: 'OpenAI',
    ...
    @node({
        id: '99237ceb-b3dd-48d5-92fc-3ea3013e0dc0',
        name: 'ParseJSON',
        type: 'n8n-nodes-base.code',
        version: 2,
        position: [960, 528],
...
return { json: parsed };`,
    ...
    @node({
        id: '012beedf-8bab-4d83-9d13-f030a2f643e9',
        name: 'Respond',
